...
NumRegularCheckouts = Inputs(1); % Between 1 and 15
NumExpressCheckouts = Inputs(2); % Between 0 and 15
NumSelfCheckouts = Inputs(3); % Between 0 and 15
% 
QueueCapacity = Inputs(4); % Same for all types of Checkouts
SelfAndExpressMaxItems = Inputs(5); % Item limit on Self and Express Checkouts
% 
TimePeriod = Inputs(6); % 1 for peak, 2 for mornings, 3 for evenings
...
if showFigures
    ...
    figure(2)
    clf
    histEdges = [0:2:max(AllNumberOfItems)+1];
    % Plot histogram of actual data
